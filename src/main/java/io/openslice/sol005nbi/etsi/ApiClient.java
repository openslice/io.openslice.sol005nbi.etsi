...
import io.openslice.sol005nbi.auth.ApiKeyAuth;
import io.openslice.sol005nbi.auth.Authentication;
import io.openslice.sol005nbi.auth.HttpBasicAuth;
import io.openslice.sol005nbi.auth.OAuth;


@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-03-31T22:46:27.985+03:00[Europe/Athens]")@Component("io.openslice.sol005nbi.api.ApiClient")
    ...
    */
    ...
    protected RestTemplate buildRestTemplate() {
    	...
    	try {
	    	...
	    	RestTemplate arestTemplate = new RestTemplate( new BufferingClientHttpRequestFactory(requestFactory));

	    	List<ClientHttpRequestInterceptor> interceptors = new ArrayList<>();
	    	arestTemplate.setInterceptors(interceptors);
	    	
	        //RestTemplate restTemplate = new RestTemplate();
	        // This allows us to read the response more than once - Necessary for debugging.
	        BufferingClientHttpRequestFactory fact = new BufferingClientHttpRequestFactory(arestTemplate.getRequestFactory());
	        arestTemplate.setRequestFactory( fact);
	               
	        
	        return arestTemplate;
